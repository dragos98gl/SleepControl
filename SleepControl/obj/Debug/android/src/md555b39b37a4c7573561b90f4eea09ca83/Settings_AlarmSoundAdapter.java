...
/** @hide */
	...
	public Settings_AlarmSoundAdapter (android.content.Context p0, int p1) throws java.lang.Throwable
	{
		super (p0, p1);
	...
	public Settings_AlarmSoundAdapter (android.content.Context p0, int p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == Settings_AlarmSoundAdapter.class)
	...
	public Settings_AlarmSoundAdapter (android.content.Context p0, int p1, java.lang.Object[] p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == Settings_AlarmSoundAdapter.class)
	...
	public Settings_AlarmSoundAdapter (android.content.Context p0, int p1, int p2, java.lang.Object[] p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == Settings_AlarmSoundAdapter.class)
	...
	public Settings_AlarmSoundAdapter (android.content.Context p0, int p1, java.util.List p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == Settings_AlarmSoundAdapter.class)
	...
	public Settings_AlarmSoundAdapter (android.content.Context p0, int p1, int p2, java.util.List p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == Settings_AlarmSoundAdapter.class)
